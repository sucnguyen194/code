                ...
                <div class="card-box table-responsive">
                    <div class="action-datatable text-right">
                        ...
                        <a href="{{route('admin.recruitments.categories.create')}}" class="ajax-modal btn btn-primary waves-effect width-md waves-light mb-2">
                            <span class="icon-button"><i class="fe-plus"></i></span> {{__('lang.create')}} <span class="text-lowercase">{{__('lang.category')}}</span></a>
                        @endcan
                    </div>
                    ...
                    <div class="table-bootstrap">
                        <table class="table table-bordered table-hover bs-table"
                               ...
                               data-url="{{ route('admin.categories.data',['type' => \App\Enums\CategoryType::recruitment]) }}"
    ...
    <script>
        ...
        function actionFormatter(value, row){
            ...
            @can('recruitment.edit')
                html += '<a href="'+ '{{ route('admin.recruitments.categories.edit', ':id') }}'.replace(':id',row.id) +'" class="ajax-modal btn btn-primary waves-effect waves-light"><i class="fe-edit-2"></i></a> ';
            @endcan
