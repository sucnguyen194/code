    ...
    <form action="{{route('admin.categories.store')}}" method="post" class="ajax-form" enctype="multipart/form-data">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('_add_new')}} <span class="text-lowercase">{{__('lang.category')}}</span></h5>
            ...
            <div class="modal-body">
               @include('admin.render.create.nav')
                ...
                <input type="hidden" name="data[type]" value="{{\App\Enums\CategoryType::recruitment}}">
            </div>
