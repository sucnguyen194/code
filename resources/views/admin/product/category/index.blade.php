...
@section('title') {{__('_category_product')}} @stop
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{__('_category_product')}}</li>
                        </ol>
                    </div>
                    <h4 class="page-title"> {{__('_category_product')}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                ...
                <div class="card-box table-responsive">
                    <div class="action-datatable text-right">
                        ...
                        <a href="{{route('admin.products.categories.create')}}" class="ajax-modal btn btn-primary waves-effect width-md waves-light mb-2">
                            <span class="icon-button"><i class="fe-plus"></i></span> {{__('_add_new')}} {{\Illuminate\Support\Str::lower(__('lang.category'))}}</a>
                        @endcan
                    </div>
