    ...
    <form action="{{route('admin.categories.update',$category)}}" method="post" class="ajax-form" enctype="multipart/form-data">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Danh mục bài viết #ID{{$category->id}}</h5>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" data-toggle="select2" name="data[parent_id]">
                        ...
                        @foreach($categories as $item )
                            <option value="{{$item->id}}" {{selected($item->id, $category->parent_id)}} class="font-weight-bold">{{$item->translation->name}}</option>
                        @endforeach
                    </select>
                </div>
                            ...
                            <div class="media-body ml-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <input name="data[image]" id="image_url" data-target="#image_src" value="{{$category->image}}"  type="text" class="form-control" placeholder="http://">
