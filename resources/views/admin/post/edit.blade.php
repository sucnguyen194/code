        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Blog #ID{{$post->id}}</h4>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card-box position-relative box-action-image">
                        ...
                        <div class="dropzone p-2 text-center">
                            <div class="dz-message text-center needsclick mb-1 {{$post->image ? "d-none" : ""}}" id="image_hidden">
                            ...
                            <img src="{{$post->image}}" alt="" class="rounded mb-1 {{!$post->image ? "d-none" : ""}}" id="image_src">
                            <div class="input-group">
                                <div class="input-group-prepend"><span id="basic-addon1" class="input-group-text">src</span></div>
                                <input type="text" name="data[image]" placeholder="Đường dẫn ảnh" id="image_url" value="{{$post->image}}" class="form-control image-src" data-target="#image_src" data-hidden="#image_hidden">
                            </div>
                        </div>
                    </div>
