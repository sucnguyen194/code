<div class="card-box">
    <div class="form-group select-category mb-0">
        ...
        <a href="{{route('admin.categories.create',['type' => $type, 'selected' => '.category-main', 'option' => '.category-sub'])}}" class="edit-seo ajax-modal font-weight-medium add-category">{{__('lang.create')}} <span class="text-lowercase">{{__('lang.category')}}</span></a>
