...
<div class="card-box">
    ...
    <a href="{{route('admin.categories.create',['type' => $type, 'selected' => '.category-sub', 'option' => '.category-main'])}}" class="edit-seo ajax-modal font-weight-medium">{{__('lang.create')}} <span class="text-lowercase">{{__('lang.category')}}</span></a>
