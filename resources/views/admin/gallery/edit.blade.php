    ...
    <form action="{{route('admin.products.update',$gallery)}}" method="post" class="ajax-form" enctype="multipart/form-data">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Thư viện #ID{{$gallery->id}}</h5>
            ...
            <div class="modal-footer">
                <div class="d-none">
                    ...
                    <hr>
                    <div class="checkbox">
                        <input id="checkbox_public" {{checked($gallery->public, 1)}} type="checkbox" value="1" name="public">
                        <label for="checkbox_public">Hiển thị</label>
                    </div>

                    <div class="checkbox">
                        <input id="checkbox_status" {{checked($gallery->status, 1)}} type="checkbox" value="1" name="status">
