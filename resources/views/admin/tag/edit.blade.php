...
<div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 800px!important" role="document">
    <form action="{{route('admin.tags.update',$tag)}}" method="post" class="ajax-form w-100" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{__('_tag')}} #{{$tag->id}}</h5>
