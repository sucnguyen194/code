...
@section('scripts')
    <script>
        ...
        function actionFormatter(value, row){
            ...
            if(row.image)
              html +='<a href="javascript:void(0)" class="btn btn-facebook  coppy-image waves-effect waves-light tooltip-hover" title="{{__('_copy_image')}}" data-image="'+row.image+'"><i class="fe-copy"></i></a>';
