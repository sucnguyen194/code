...
@section('title') {{__('_support_team')}} @stop
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{__('_support_team')}}</li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{__('_support_team')}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="action-datatable text-right">
                        @can('support.create')
                            @include('admin.render.add_new', ['route' => route('admin.supports.create'), 'modal' => true])
                        @endcan
                    </div>
