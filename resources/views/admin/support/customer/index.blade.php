...
@section('title') {{__('lang.customer_reviews')}} @stop
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{__('lang.customer_reviews')}}</li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{__('lang.customer_reviews')}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                ...
                <div class="card-box table-responsive">
                    <div class="action-datatable text-right">
                        ...
                        <a href="{{route('admin.supports.customers.create')}}" class="btn btn-primary waves-effect width-md waves-light mb-2 ajax-modal">
                            <span class="icon-button"><i class="fe-plus"></i></span> {{__('_add_new')}} <span class="text-lowercase">{{__('lang.review')}}</span></a>
                        @endcan
                    </div>
                    ...
                    <div class="table-bootstrap">
                        <table class="table table-bordered table-hover bs-table"
                               ...
                               data-url="{{ route('admin.supports.data',['type' => \App\Enums\SupportType::customer]) }}"
