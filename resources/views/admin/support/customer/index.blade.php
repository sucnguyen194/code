                ...
                <div class="card-box table-responsive">
                    ...
                    <div id="custom-toolbar">
                        <form method="get" class="form-inline filter-form">
                            ...
                            <div class="mr-2 mb-2" style="width: 200px">
                                <select class="form-control" data-toggle="select2" name="admin">
...
@section('scripts')
    <script>
        ...
        function actionFormatter(value, row){
            let html = '<a href="'+ '{{ route('admin.supports.customers.edit', ':id') }}'.replace(':id',row.id) +'" class="btn btn-primary waves-effect waves-light ajax-modal"><i class="fe-edit-2"></i></a> ';
