...
@section('title') {{__('_customer_reviews')}} @stop
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">{{__('_customer_reviews')}}</li>
                        </ol>
                    </div>
                    <h4 class="page-title">{{__('_customer_reviews')}}</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12">
                <div class="card-box table-responsive">
                    <div class="action-datatable text-right">
                        @can('support.create')
                            @include('admin.render.add_new', ['route' => route('admin.supports.customers.create'), 'modal' => true])
                        @endcan
                    </div>
                    ...
                    <div class="table-bootstrap">
                        ...
                        >
                            <thead>
                            <tr>
                                <th data-field="id" data-width="100" data-sortable="true">{{__('_id')}}</th>
...
@section('scripts')
    <script>
        ...
        function actionFormatter(value, row){
            let html = '';
            @can('support.edit')
                html += '<a href="'+ '{{ route('admin.supports.customers.edit', ':id') }}'.replace(':id',row.id) +'" title="@lang('_edit')" class="btn btn-primary waves-effect waves-light ajax-modal"><i class="fe-edit-2"></i></a> ';
            @endcan
