                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="account-box">
                            <div class="account-logo-box">
                                ...
                                {{--                                    </a>--}}
                                {{--                                </div>--}}
                                <h5 class="text-uppercase mb-1 mt-0">@lang('_login')</h5>
                            ...
                            <div class="account-content mt-4">
                                <div class="text-center mb-3">
                                    <div class="mb-3">
                                        <img src="{{setting('site.logo') ?? '/lib/assets/images/logo-dark.png'}}" height="30" class="" alt="thumbnail">
                                    </div>

                                    <p class="text-muted mb-0 font-13">@lang('_enter_password')</p>
                                </div>
                                ...
                                <form class="form-horizontal ajax-form" action="{{route('maintenance')}}" method="post">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label for="password">@lang('_password')</label>
                                    ...
                                    <div class="form-group row text-center mb-0 mt-2">
                                        <div class="col-12">
                                            <button class="btn btn-md btn-block btn-primary waves-effect waves-light" type="submit">@lang('_login')</button>
                                        </div>
                                    </div>
