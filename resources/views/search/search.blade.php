...
@section('title') Search #{{request()->key}} @stop
@section('content')
            ...
            <div class="elementor-section-wrap">
                <section
                    ...
                    <div class="elementor-container elementor-column-gap-default">
                        <div class="elementor-row">
                            <div
                                class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-e8c336c"
                ...
                <section
                    ...
                    <div class="elementor-container elementor-column-gap-default">
                        <div class="elementor-row">
                            <div
                                class="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-f523beb"
                                data-id="f523beb" data-element_type="column">
                                <div class="elementor-column-wrap elementor-element-populated">
                                    <div class="elementor-widget-wrap">
                                        <div
                                            class="elementor-element elementor-element-ba68429 elementor-widget elementor-widget-instive-post-slider"
                                 ...
                                 {{$post->item->created_at->diffforHumans()}}
                              </span>
                                                                </div>
