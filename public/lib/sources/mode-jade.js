...
var ScssHighlightRules = function() {
    ...
    var keywords = lang.arrayToMap(
        ("@mixin|@extend|@partials|@import|@media|@debug|@warn|@if|@for|@each|@while|@else|@font-face|@-webkit-keyframes|if|and|!default|module|def|end|declare").split("|")
    );
...
var JadeHighlightRules = function() {
    ...
    "start": [
        {
            token: "keyword.control.import.partials.jade",
            regex: "\\s*\\binclude\\b"
        },
        {
