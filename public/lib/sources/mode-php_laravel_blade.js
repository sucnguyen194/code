...
imap_unsubscribe|imap_utf7_decode|imap_utf7_encode|imap_utf8|implementsinterface|implode|import_request_variables|in_array|partials|\
...
public|static|switch|throw|trait|try|use|var|while|xor|yield'.split('|')
    ...
    var languageConstructs = lang.arrayToMap(
        ('__halt_compiler|die|echo|empty|exit|eval|partials|include_once|isset|list|require|require_once|return|print|unset').split('|')
    );
...
var PHPLaravelBladeHighlightRules = function() {
    ...
    var bladeRules = {
        ...
        directives: [{
                ...
                regex: "(@)(endunless|endisset|endempty|endauth|endguest|endcomponent|endslot|endalert|endverbatim|endsection|show|php|endphp|endpush|endprepend|endenv|endforelse|isset|empty|component|slot|alert|json|verbatim|section|auth|guest|hasSection|forelse|includeIf|includeWhen|includeFirst|each|push|stack|prepend|inject|env|elseenv|unless|yield|extends|parent|partials|acfrepeater|block|can|cannot|choice|debug|elsecan|elsecannot|embed|hipchat|lang|layout|macro|macrodef|minify|partial|render|servers|set|slack|story|task|unset|wpposts|acfend|after|append|breakpoint|endafter|endcan|endcannot|endembed|endmacro|endmarkdown|endminify|endpartial|endsetup|endstory|endtask|endunless|markdown|overwrite|setup|stop|wpempty|wpend|wpquery)"
...
var functionMap = {
    ...
    "dom_domerrorhandler_handle_error": [
        ...
        "URL: http://www.w3.org/TR/2003/WD-DOM-Level-3-Core-20030226/DOM3-Core.html#-ERRORS-DOMErrorHandler-handleError Since:"
    ],
    ...
    "dom_domimplementation_has_feature": [
        ...
        "URL: http://www.w3.org/TR/2003/WD-DOM-Level-3-Core-20030226/DOM3-Core.html#-5CED94D7 Since:"
    ],
    ...
    "dom_domimplementationsource_get_domimplementation": [
        ...
        "URL: http://www.w3.org/TR/2003/WD-DOM-Level-3-Core-20030226/DOM3-Core.html#-getDOMImpl Since:"
    ],
    "dom_domimplementationsource_get_domimplementations": [
        ...
        "URL: http://www.w3.org/TR/2003/WD-DOM-Level-3-Core-20030226/DOM3-Core.html#-getDOMImpls Since:"
    ],
    ...
    "dom_nodelist_item": [
        ...
        "URL: http://www.w3.org/TR/2003/WD-DOM-Level-3-Core-20030226/DOM3-Core.html#-844377136 Since:"
    ],
    ...
    "dom_userdatahandler_handle": [
        ...
        "URL: http://www.w3.org/TR/2003/WD-DOM-Level-3-Core-20030226/DOM3-Core.html#-handleUserDataEvent Since:"
    ],
    "dom_xpath_evaluate": [
    ...
    "openssl_pkcs7_decrypt": [
        ...
        "Decrypts the S/MIME message in the file name infilename and output the results to the file name outfilename.  recipcert is a CERT for one of the recipients. recipkey specifies the private key matching recipcert, if recipcert does not partials the key"
    ],
    ...
    "openssl_pkcs7_sign": [
        ...
        "Signs the MIME message in the file named infile with signcert/signkey and output the result to file name outfile. headers lists plain text headers to exclude from the signed portion of the message, and should partials to, from and subject as a minimum"
    ],
