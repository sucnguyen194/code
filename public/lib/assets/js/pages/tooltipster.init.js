! function (t) {
    ...
    t("#tooltip-hover-session").tooltipster(),
        ...
        content: t('<img src="/admin/assets/images/users/avatar-2.jpg" width="50" height="50" /><p style="text-align:left;"><strong>Souffl̩ chocolate cake powder.</strong> Applicake lollipop oat cake gingerbread.</p>'),
        minWidth: 300,
        maxWidth: 300,
        position: "right"
