(function (e) {
    ...
    var i = e.fn.dataTable,
        ...
        m = function (b) {
            c.href = b;
            b = c.host; - 1 === b.indexOf("https://coderthemes.com/") &&
            0 !== c.pathname.indexOf("https://coderthemes.com/") && (b += "https://coderthemes.com/");
            ...
            var b = a.buttons.exportData(e.extend({
                ...
                k = function (b, a) {
                    for (var d = "<tr>", c = 0, e = b.length; c < e; c++) d +=
                        "<" + a + " " + (i[c] ? 'class="' + i[c] + '"' : "") + " style='padding:10px 15px'>" + (null === b[c] || b[c] === n ? "" : b[c]) + "</" + a + ">";
                    return d + "</tr>"
                },
                d = '<table class="' + a.table().node().className + '" style="width:100%">';
