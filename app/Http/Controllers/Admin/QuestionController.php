...
class QuestionController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.support.question.create');
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Support $question)
    {
        $this->authorize('support.edit');
        $translations = $question->translations->load('language');
        return view('admin.support.customer.edit',compact('question','translations'));
    }
